...
FM.objectType = function (pName) {
    ...
    that.overlapsWithObject = function (pGameObject) {
        var quad = FM.game.getCurrentState().getQuad(),
            ...
            //gameObjects = FM.game.getCurrentState().members,
            i,
            otherGameObject,
            physic,
            otherPhysic;
        for (i = 0; i < gameObjects.length; i = i + 1) {
            ...
            //TODO fucked up
            //if (otherPhysic) {
                //console.log(otherGameObject.getId());
            //}
            if (otherPhysic && otherGameObject.getTypes()[0]) {
                //console.log(otherGameObject.getTypes()[0].getName());
                //console.log(otherGameObject.getId());
                if (otherGameObject.hasType(that)) {
                    //console.log(otherGameObject.components[FM.componentTypes.SPATIAL].position.x);
                }
